...
/* space 后代选择器 */
/* 当使用 空格 连接两个元素时，
使得该选择器可以只匹配那些由第一个元素作为祖先元素的所有第二个元素(后代元素)，
不包含第一个元素 */
...
/* * */
/* 所有的 html 元素，一般搭配其他符号进行筛选使用 */
.container ~ * {} /* class="container" 元素同层的所有 html 元素 */
```
